...
app = webapp2.WSGIApplication([
    ...
    webapp2.Route(r'/people/<email>/checkouts/<chid:[0-9]+>', 'api.checkout'),
    ...
    webapp2.Route(r'/books/<bid:[0-9]+>/copies/<coid:[0-9]+>', 'api.copy'),
    webapp2.Route(r'/books/<bid:[0-9]+>/copies/<coid:[0-9]+>/history', 'api.copyhistory'),
    ], debug=True)